...
const About = () => {
  const team = [
    {
      name: "Игорь Коваленко",
      position: "Генеральный директор",
      experience: "12 лет",
      specialization: "Энергетическое проектирование",
      achievements: ["Высшее техническое образование", "Опыт в крупных энергокомпаниях", "150+ проектов"]
    },
    {
      name: "Марина Сидорова", 
      position: "Главный инженер",
      experience: "10 лет",
      specialization: "Электротехнические системы",
      achievements: ["Кандидат технических наук", "Лицензия ПУЭ", "Специалист по автоматизации"]
    },
    {
      name: "Алексей Петров",
      position: "Начальник производства",
      experience: "8 лет", 
      specialization: "Монтаж электросистем",
      achievements: ["Сертификат электрика 5 разряда", "Опыт монтажа на промышленных объектах", "100+ проектов"]
    },
    {
      name: "Екатерина Новикова",
      position: "Менеджер по качеству",
      experience: "6 лет",
      specialization: "Контроль качества работ",
      achievements: ["Сертификат ISO 9001", "Опыт в энергоаудите", "Контроль 80+ проектов"]
    }
  ];

  const certificates = [
    {
      title: "Лицензия Минэнерго Крыма",
      number: "№ КР-Э-24-0089 от 15.06.2021",
      description: "Лицензия на проведение работ по проектированию и монтажу электроустановок",
      icon: "Zap"
    },
    {
      title: "Сертификат ИСО 9001:2015",
      number: "Сертификат № РОСС RU.7706.04.QSZ0.00894",
      description: "Система менеджмента качества в области энергетических услуг",
      icon: "Award"
    },
    {
      title: "Допуск СРО",
      number: "№ СРО-П-201-25042021",
      description: "Свидетельство о допуске к работам по проектированию электротехнических систем",
      icon: "FileText"
    },
    {
      title: "Партнерство с поставщиками",
      number: "ABB, Schneider Electric, IEK, KEAZ",
      description: "Официальные дилерские соглашения с ведущими производителями электрооборудования",
      icon: "Handshake"
    }
  ];
  ...
  const milestones = [
    { year: "2015", event: "Основание компании", description: "Начало работы на энергетическом рынке Крыма" },
    { year: "2017", event: "Первые крупные проекты", description: "Монтаж энергосистем для промышленных объектов" },
    { year: "2019", event: "Расширение деятельности", description: "Открытие собственного проектного отдела" },
    { year: "2021", event: "Получение лицензий", description: "Лицензии на проектирование и монтаж энергообъектов" },
    { year: "2022", event: "Партнерство с поставщиками", description: "Сотрудничество с ведущими производителями оборудования" },
    { year: "2024", event: "150+ проектов", description: "Успешное выполнение проектов различной сложности" }
  ];
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto animate-fade-in">
              С 2015 года создаем надежные энергетические решения для предприятий Крыма. 
              Полный цикл от проектирования до технического обслуживания.
            </p>
            
            {/* Статистика */}
            <div className="grid md:grid-cols-3 gap-8 mt-12 animate-slide-up">
              <div className="text-center hover-scale">
                <div className="text-4xl font-bold text-blue-300 mb-2 animate-pulse-slow">150+</div>
                <div className="text-lg text-gray-300">Реализованных проектов</div>
              </div>
              <div className="text-center hover-scale">
                <div className="text-4xl font-bold text-blue-300 mb-2 animate-pulse-slow">9</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-up">
              ...
              <div className="space-y-4 text-gray-600 text-lg">
                <p>
                  ООО «ЭнергоАльянс-Крым» — надежная энергетическая компания, специализирующаяся на 
                  проектировании, поставке и монтаже энергетического оборудования с 2015 года.
                </p>
                <p>
                  Мы обеспечиваем комплексные решения для предприятий Крыма в области электроснабжения, 
                  автоматизации и энергоэффективности. Наша экспертиза охватывает промышленные объекты, 
                  коммерческие здания и социальную инфраструктуру.
                </p>
                <p>
                  Приоритет компании — повышение энергетической эффективности и надежности 
                  электроснабжения объектов заказчиков за счет современных технологических решений.
                </p>
              </div>
            </div>
